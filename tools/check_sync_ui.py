...
ITEM={"id":"test-record","risk":"high","title":"Test evidence","summary":"", "surface":"Claude.ai", "created_at":"2026-09-08T00:00:00Z", "user":{"email":"test@example.com"}, "messages":[], "risk_scoring_basis":"user_text", "risk_review_notes":["Workflow approval unknown: <script>bad()</script>"],"risk_factors":[{"id":"unauthorized_app_generation","points":60}]}
