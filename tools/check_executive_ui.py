...
def route_app(route):
    ...
    elif path=="/api/usage" and "Copilot" in route.request.url:route.fulfill(json={"summary":{"copilot_active_users":8,"copilot_enabled_users":12},"report_refresh_date":"2026-09-06","charts_html":"","executive_sections":[]})
